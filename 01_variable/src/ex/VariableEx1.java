...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - 논리형 -
		 * boolean(1byte) - true / flase
		 * 
		 * - 정수형 - 
		 * byte  (1byte)
		 * short (2byte)
		 * int   (4byte) - 정수 기본형(123-> int로 인식)
		 * long  (8byte) - 숫자 뒤에 l 또는 L을 붙임(123l, 123L)
		 * 
		 * - 실수형 - 
		 * float  (4byte) - 숫자 뒤에 f 또는 F를 붙임(3.14f, 3.14F)
		 * double (8byte) - 실수 기본형
		 * - 문자형 - 
		 * 
		...
		// 변수 선언 : 메모리에 값을 저장할 공간을 만듬(== 할당)
		
		int num1; // 메모리에 int형 데이터를 저장하기 위한 
				  // 공간 4byte를 할당하고 변수 이름을 num1이라고 지정
		
		// 자바 초기화(처음 값 대입) 되지 않은
		...
		// 왜? 실수 기본형은 double (1.23 처럼 보통 실수 표기법이 double로 인식됨)
...
//		char ch6 = "A"; // 쌍따옴표 "" 안됨
		 ...
		 * 정확도가 2배 == 소수점 표현 자릿 수가 2배라서 double이다.
		 */
		...
		System.out.println(test1); // 1.1234568 (7 ~ 8)
		System.out.println(test2); // 1.1234567890123457 (15 ~ 16)
