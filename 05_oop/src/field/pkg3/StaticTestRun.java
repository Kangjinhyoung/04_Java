...
public class StaticTestRun {
	public static void main(String[] args) {
		...
		k1.setName("강진형");
		k1.setId("991014-1111111");
		
		Korean k2 = new Korean();
		k2.setName("박현정");
		k2.setId("990710-2222222");
		...
		System.out.println("\n[static 변수 값 변경 확인]");
		// static은 값을 공유하고 있기 때문에 한 번만 
		// 바꾸면 공유하는 모든 객체의 값이 변경된다
		k1.nationCode = 10;
		// k2.nationCode = 10; // 불필요한 코드
		System.out.printf("k1 : %d / %s / %s \n", k1.nationCode, k1.getName(), k1.getId());
		System.out.printf("k2 : %d / %s / %s \n", k2.nationCode, k2.getName(), k2.getId());
		
		// 왜 k1.nationaalCode / k2.nationalCode에 노란줄이 뜰까?
		
		// The static field Korean.nationCode should be accessed in a static way
		// -> 정적 방식으로 접근하는게 좋다
		// -> static 영엑에 생성된 이름으로 호출하는게 좋다
		System.out.println("\n");
