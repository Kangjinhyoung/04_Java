...
public class Member {
	...
	// 인스턴스 변수에 대입되는 값이 없다면 각 자료형의 기본 값으로 초기화된다.
	// ex) int : 0 / double : 0.0 / boolean : false / 참조형 : null
	
	/* null : 현재 참조하고 있는 객체가 없음을 의미한다. */
		
	/* 생성자 */
	/* - 작성 규칙 
	 * 1. 반환형이 없다(void, String, int ... 안씀)
	 * 2. 생성자 이름은 클래스명과 동일
	 */
	/** 기본 생성자 
	 *  - 매개 변수가 없는 생성자를 의미
	...
	/** 매개 변수 생성자
	 * - 매개 변수가 존재하는 생성자
	 * - 전달 받은 매개 변수를 이용해 생성되는 
	 *   객체의 필드를 초기화 하는 용도로 많이 사용 
	 */
...
//	public String method() {} // 반환형 다름 -> 중복 O
	 ...
	 *   전달 받은 매게 변수에 따라 조금씩 동작이 달라야하는 경우
	 *   상황 별로 메서드를 정의할 수 있음
	 *   
	 *   ex) 
