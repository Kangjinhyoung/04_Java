...
public class Person {
	 ...
	 * - 현재 객체와 매개 변수로 전달 받은 다른 객체의 필드 값이 
	 * 	 일치하는지 확인하는 용도로 오버라이딩해서 사용하는 Object 제공 메서드 
	 */
	@Override
	public boolean equals(Object other) {
		...
		return true; // 위에 if문 실행이 안되면 같은 값을 지닌 객체
	}
	 ...
	 *   ex) sha-256 암호화 방식 -> 문자열을 전달하면 256바이트 길이 문자열로 변환
	 */
	@Override
	public int hashCode() {
