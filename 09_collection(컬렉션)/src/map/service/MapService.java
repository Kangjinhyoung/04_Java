...
public class MapService {
	...
	public void test1() {
		...
		// 1. V put(K k, V v) : Map에 K:V 한 쌍을 추가, 추가 성공 시 Value가 반환됨 
		...
		// 2. V get(K k) : 해당 Key에 대응되는 Value 반환 -> 단, 일치하는 K가 없으면 null 반환
	...
	public void test2() {
		...
		/* 1) Map.keySet() 이용 -> key만 모아둔 집합(set) 반환 */
		...
		/* 2) Map.entrySet() 이용 -> K:V 쌍 형태의 객체를 모아둔 집합(Set) 반환 */
