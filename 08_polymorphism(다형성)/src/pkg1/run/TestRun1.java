...
//		System.out.println(p2.getCar());
		...
		/* Object를 이용한 업캐스팅 + 객체 타입에 따른 다운 캐스팅 */
		 ...
		 * - 참조 하고 있는 객체가 클래스명 객체가 맞는지 확인 (true / false)
		 * -- 주의 사항 --
		 ...
		 *    
		 *    p instanceof Child -> p가 참조하고 있는 객체가 Child야? true
		 *    p instanceof Parent -> p가 참조하고 있는 객체가 Parent야? true
		 *    
		 *  -> 주의 사항을 잘 이용하면 Parent, Child 클래스 상속 관계가 맞는지
		 *     확인하는 용도로도 사용 가능!
		 */
		
		// 향상된 for문
		for(Object obj : arr) {			
/* tip : 자료형을 연달아 검사하는 경우 마지막 자식 자료형부터 검사하는게 좋다! */
			// 얻어온 요소가 Child 타입이면
