 ...
 * 
 * [역직렬화 방법]
 * - ObjectInputStream을 이용해서 직렬화된 객체를 읽어오게 되면 자동으로 역직렬화가 수행됨
 * ***************************************************************************************
 */
public class ObjectService {
	...
	public void objectOutput() {
		...
		try {
			...
			// 출력 스트림 객체 생성
			fos = new FileOutputStream(folder + "/Member.dat"); // /io_test/object/Member.dat
			...
			// NotSerializableException - 직렬화가 안되었다
	...
	public void objectInput() {
		...
		try {
			...
			// 직렬화된 객체를 읽어와 역직렬화 후 Member 타입으로 다운 캐스팅
